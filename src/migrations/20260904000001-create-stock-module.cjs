...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('warehouses', {
      ...
      company_id: { allowNull: false, type: Sequelize.INTEGER, defaultValue: 1 },
      nombre: { allowNull: false, type: Sequelize.STRING(255) },
      codigo: { allowNull: false, type: Sequelize.STRING(10) },
      direccion: { allowNull: true, type: Sequelize.STRING(255) },
    ...
    await queryInterface.createTable('providers', {
      id: { allowNull: false, autoIncrement: true, primaryKey: true, type: Sequelize.INTEGER },
      nombre: { allowNull: false, type: Sequelize.STRING(255) },
      cuit: { allowNull: true, type: Sequelize.STRING(20) },
      email: { allowNull: true, type: Sequelize.STRING(255) },
      telefono: { allowNull: true, type: Sequelize.STRING(50) },
      activo: { allowNull: false, type: Sequelize.BOOLEAN, defaultValue: true },
      createdAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
      updatedAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
    });
    ...
    await queryInterface.createTable('product_presentations', {
      ...
      cantidad_base: { allowNull: true, type: Sequelize.DECIMAL(15, 4) },
      activo: { allowNull: false, type: Sequelize.BOOLEAN, defaultValue: true },
      createdAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
      updatedAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
    });
    ...
    await queryInterface.createTable('product_lots', {
      ...
      lot_number: { allowNull: false, type: Sequelize.STRING(255) },
      manufacturing_date: { allowNull: true, type: Sequelize.DATEONLY },
      expiration_date: { allowNull: true, type: Sequelize.DATEONLY },
      quantity_base: { allowNull: true, type: Sequelize.DECIMAL(15, 4) },
      createdAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
      updatedAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
    });
    ...
    await queryInterface.createTable('warehouse_stock', {
      ...
      quantity: { allowNull: false, type: Sequelize.DECIMAL(15, 4), defaultValue: 0 },
      createdAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
      updatedAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
    });
    await queryInterface.addIndex('warehouse_stock', ['warehouse_id', 'product_id', 'product_lot_id'], {
      unique: true, name: 'warehouse_stock_unique',
    });
    ...
    await queryInterface.createTable('purchases', {
      ...
      purchase_date: { allowNull: false, type: Sequelize.DATEONLY },
    ...
    await queryInterface.createTable('purchase_items', {
      ...
      quantity: { allowNull: false, type: Sequelize.DECIMAL(15, 4) },
      createdAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
      updatedAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
    });

    // =================================================================
    // 8. PURCHASE_ITEM_LOTS
    // =================================================================
    ...
    await queryInterface.createTable('remitos', {
      id: { allowNull: false, autoIncrement: true, primaryKey: true, type: Sequelize.INTEGER },
      company_id: { allowNull: false, type: Sequelize.INTEGER, defaultValue: 1 },
      remito_number: { allowNull: false, type: Sequelize.STRING(20) },
      type: { allowNull: false, type: Sequelize.ENUM('OFICIAL', 'NO_OFICIAL') },
      status: { allowNull: false, type: Sequelize.ENUM('PENDIENTE', 'DESPACHADO', 'RECIBIDO', 'ANULADO'), defaultValue: 'PENDIENTE' },
      origin_warehouse_id: {
        allowNull: false, type: Sequelize.INTEGER,
        references: { model: 'warehouses', key: 'id' },
        onUpdate: 'CASCADE', onDelete: 'CASCADE',
      ...
      issued_at: { allowNull: true, type: Sequelize.DATE },
      dispatched_at: { allowNull: true, type: Sequelize.DATE },
      received_at: { allowNull: true, type: Sequelize.DATE },
      created_by: {
        allowNull: true, type: Sequelize.INTEGER,
        references: { model: 'users', key: 'id' },
        onUpdate: 'CASCADE', onDelete: 'SET NULL',
    ...
    await queryInterface.addIndex('remitos', ['company_id', 'origin_warehouse_id', 'remito_number'], {
      unique: true, name: 'remitos_unique_number',
    });
    ...
    await queryInterface.createTable('remito_items', {
      ...
      quantity_requested: { allowNull: true, type: Sequelize.DECIMAL(15, 4) },
      quantity_dispatched: { allowNull: true, type: Sequelize.DECIMAL(15, 4) },
      description: { allowNull: true, type: Sequelize.STRING(255) },
      createdAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
      updatedAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
    });
    ...
    await queryInterface.createTable('remito_item_lots', {
      ...
      quantity_dispatched: { allowNull: false, type: Sequelize.DECIMAL(15, 4) },
      createdAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
      updatedAt: { allowNull: false, type: Sequelize.DATE, defaultValue: Sequelize.literal('CURRENT_TIMESTAMP') },
    });
    ...
    await queryInterface.createTable('stock_movements', {
      ...
      movement_type: { allowNull: false, type: Sequelize.ENUM('ENTRADA', 'SALIDA') },
      quantity: { allowNull: false, type: Sequelize.DECIMAL(15, 4) },
      reference_type: { allowNull: true, type: Sequelize.STRING(50) },
      ...
      movement_date: { allowNull: true, type: Sequelize.DATE },
      created_by: {
        allowNull: true, type: Sequelize.INTEGER,
        references: { model: 'users', key: 'id' },
        onUpdate: 'CASCADE', onDelete: 'SET NULL',
